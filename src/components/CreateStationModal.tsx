    ...
    >
      ...
      <div className="relative w-full max-w-xl bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
          <div>
            <h2 className="text-base font-bold text-gray-900">Cadastrar Estação</h2>
            <p className="text-xs text-gray-500 mt-0.5">
              Preencha os dados para criar uma nova estação.
            </p>
          </div>
          <button
            type="button"
        ...
        <form onSubmit={modal.submit} className="px-6 py-5">
          ...
          <div className="mt-6 flex items-center justify-end gap-3"> 
            ...
            >
              {modal.isCreating ? "Salvando..." : "Cadastrar"}
            </button>
          </div>
        </form>
      </div>
